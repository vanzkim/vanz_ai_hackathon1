...
namespace OccaSoftware.Buto.Editor
{
    ...
    public class ButoLightEditor : UnityEditor.Editor
    {
        ...
        private static class Props
        {
            ...
            public static SerializedProperty IntensityMultiplier;
        ...
        private void OnEnable()
        {
            ...
            Props.IntensityMultiplier = serializedObject.FindProperty(nameof(Props.IntensityMultiplier));
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (Props.inheritDataFromLightComponent.boolValue)
            {
                ...
                if (Props.lightComponent.objectReferenceValue != null)
                {
                    ...
                    EditorGUILayout.PropertyField(Props.IntensityMultiplier);
                    EditorGUI.BeginDisabledGroup(true);
